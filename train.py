...
class CaptchaDataset(Dataset):
    def __init__(self, audio_dir, image_dir, vocab, max_audio_len=100, max_image_len=100):
    ...
    def __getitem__(self, idx):
        ...
        image_sequence = pad_sequence(torch.tensor(image_sequence, dtype=torch.float32), self.max_audio_len)
